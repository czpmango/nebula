...
#include "graph/optimizer/rule/PushFilterDownAppendVTraverseRule.h"
...
std::unique_ptr<OptRule> PushFilterDownAppendVTraverseRule::kInstance =
    std::unique_ptr<PushFilterDownAppendVTraverseRule>(new PushFilterDownAppendVTraverseRule());

PushFilterDownAppendVTraverseRule::PushFilterDownAppendVTraverseRule() {
  RuleSet::QueryRules().addRule(this);
}

const Pattern& PushFilterDownAppendVTraverseRule::pattern() const {
...
bool PushFilterDownAppendVTraverseRule::match(OptContext* ctx, const MatchedResult& matched) const {
...
StatusOr<OptRule::TransformResult> PushFilterDownAppendVTraverseRule::transform(
...
std::string PushFilterDownAppendVTraverseRule::toString() const {
  return "PushFilterDownAppendVTraverseRule";
}
