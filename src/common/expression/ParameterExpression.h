...
#ifndef COMMON_EXPRESSION_PARAMETEREXPRESSION_H_
#define COMMON_EXPRESSION_PARAMETEREXPRESSION_H_
...
public:
    ...
    Expression* clone() const override {
        return ParameterExpression::make(pool_, name());
    }
...
#endif   // COMMON_EXPRESSION_PARAMETEREXPRESSION_H_
